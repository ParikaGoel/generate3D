...
if __name__=='__main__':
    # input_file = "/home/parika/WorkingDir/complete3D/Assets/shapenet-raytraced/04379243/142060f848466cad97ef9a13efb5e3f7.txt"
    ...
    # output_folder = "/home/parika/WorkingDir/complete3D/Assets/output-network/"
    #
    # occ_grid = dataloader.load_sample(input_file)
    # gt = dataloader.load_sample(target_file)
    #
    # occ_grid = occ_grid.unsqueeze(0)
    #
    # trainer = Trainer()
    # output = trainer.train(occ_grid, gt)
    # output = output.detach()
    # output = output[0]
    # dataloader.save_sample(output_folder+"output.txt", output)
    # voxel_grid.txt_to_mesh(output_folder + "output.txt", output_folder + "output.ply")
