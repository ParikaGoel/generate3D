...
if __name__ == '__main__':
    test_list = []
    test_list.append({'synset_id': '2747177', 'model_id': '9ee464a3fb9d3e8e57cd6640bbeb736d'})
    test_list.append({'synset_id': '2747177', 'model_id': 'f67bf3e49cfffc91f155d75bbf62b80'})
    test_list.append({'synset_id': '2747177', 'model_id': '60b4017e16fd9c4f2056b4bd5d870b47'})
    test_list.append({'synset_id': '2747177', 'model_id': '2f79bca58f58a3ead2b12aa6a0f050b3'})
    test_list.append({'synset_id': '2747177', 'model_id': 'af1dc226f465990e81faebbdea6bd9be'})

    test_list.append({'synset_id': '2773838', 'model_id': '4e4fcfffec161ecaed13f430b2941481'})
    test_list.append({'synset_id': '2773838', 'model_id': '3077a9b76724b6d35de21284bb515a83'})
    test_list.append({'synset_id': '2773838', 'model_id': 'cbc2328cadf8dc573394926146371698'})
    test_list.append({'synset_id': '2773838', 'model_id': 'd3bd250ca3cb8e29976855a35549333'})
    test_list.append({'synset_id': '2773838', 'model_id': '7565e6f425dd6d376d987ae9a225629c'})
